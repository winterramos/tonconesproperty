window.addEventListener('DOMContentLoaded', () => {
  ...
  const rpaListing = {
    ...
    description: L('A brand-new home near a world-class wave with 2,550 square feet of interior living space, plus a 760-square-foot rooftop pergola and a 360-square-foot garage. The property is equipped with solar panels and a backup generator in case of a power outage.', 'Casa nueva cerca de una ola de clase mundial con 2,550 pies cuadrados de espacio interior, más una pérgola de 760 pies cuadrados en la azotea y un garaje de 360 pies cuadrados. La propiedad cuenta con paneles solares y un generador de respaldo en caso de un corte de electricidad.'),
    highlights: ES_MODE ? ['2,550 pies² interiores', 'Pérgola de 760 pies²', 'Garaje de 360 pies²', '3,670 pies² cubiertos en total', '3 recámaras / 3 baños', '2 cocinas', 'Aire acondicionado en toda la casa', 'Paneles solares', 'Generador de respaldo', 'Niveles superior e inferior independientes', 'Alberca privada'] : ['2,550 ft² interior', '760 ft² rooftop pergola', '360 ft² garage', '3,670 ft² total covered space', '3 bedrooms / 3 bathrooms', '2 kitchens', 'Air conditioning throughout', 'Solar panels', 'Backup generator', 'Independent upper + lower levels', 'Private pool'],
    ...
    gallery: [
      ...
      'assets/listings/rpa-1/22-garage-exterior.webp',
      'assets/listings/rpa-1/23-surfboard-storage-garage.webp'
    ]
  };

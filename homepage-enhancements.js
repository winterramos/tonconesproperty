(function () {
  ...
  const COLLECTION_IMAGES={
    'Homes':PTB1,
    'Condos':'/assets/images/1mainphoto-1-1696x1131.jpg',
    'Lots & Land':'/assets/images/1main.jpg-1256x888.jpg',
    'Beachfront Lots':'/assets/images/1mainphotokbf-2-1696x1199.jpg',
    'Ranch / Palo Alto':'/assets/images/1mainphoto-32-1696x1199.jpg',
    'Playa Saladita':'/assets/images/1mainphoto20vms-4-1696x1199.jpg',
    'Commercial':'/assets/images/plh11-1359x754.jpg'
  };
  ...
  function showFullGallery(code){
    ...
    if(detailHero)detailHero.src=localAsset(images[0]);
    gallery.classList.toggle('onephoto',images.length===1);
    gallery.innerHTML=images.map((src,index)=>`<img loading="${index?'lazy':'eager'}" src="${localAsset(src)}" alt="${code} property photo ${index+1}">`).join('');
  ...
  function syncListingThumbnails(){
    ...
    document.querySelectorAll('.card').forEach(card=>{
      ...
      if(image&&target)target.src=localAsset(image);
    });
  }

(function () {
  ...
  function showMobileTopTiles(){
    ...
    style.textContent='@media(max-width:900px){header nav{flex-wrap:wrap!important}.mobileMenu{display:none!important}.langChoices{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;order:3;flex:0 0 100%;gap:5px!important}.langChoice{display:flex!important;align-items:center;justify-content:center;text-align:center;white-space:nowrap;padding:8px 4px!important;font-size:9px!important;letter-spacing:.02em!important}}@media(max-width:620px){header:not(.scrolled){background:rgba(7,16,12,.34)!important}header nav{justify-content:center!important;gap:2px!important}.brand{flex:0 0 100%!important;text-align:center!important;font-size:12px!important;line-height:1.15!important;margin-bottom:4px!important}.brand small{font-size:5px!important}.langChoices{margin-top:0!important}.langChoice{padding:6px 3px!important;font-size:8.5px!important}#about{padding-bottom:22px!important}main>section:not(.hero):not([id]){padding-top:22px!important;padding-bottom:22px!important}#listings{padding-top:22px!important}.hero{min-height:0!important;height:auto!important;display:block!important;padding-top:62vw!important}.hero .wrap{padding-top:28px!important;padding-bottom:0!important;transform:translateY(8px)!important}.hero .eyebrow{margin-bottom:12px!important}.hero h1{font-size:46px!important}.hero p{font-size:18px!important;margin:16px 0 22px!important}}';
  ...
  function styleCollections(){
    if(!document.getElementById('dt-collection-photo-style')){
      ...
      style.textContent='.areas{display:grid!important;grid-template-columns:repeat(12,minmax(0,1fr))!important;gap:12px!important;background:transparent!important;border:0!important;max-width:1040px;margin-left:auto!important;margin-right:auto!important}.area{position:relative!important;overflow:hidden!important;grid-column:span 3;min-height:170px!important;padding:22px 18px!important;background-size:cover!important;background-position:center!important;color:#fff!important;text-shadow:0 2px 14px rgba(0,0,0,.8)!important;border:0!important}.area:nth-child(-n+4){grid-column:span 3}.area:nth-child(n+4){grid-column:span 3}.area:before{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(8,18,15,.08),rgba(8,18,15,.72));z-index:0}.area>*{position:relative;z-index:1}.area b{font-size:clamp(20px,2.2vw,30px)!important}.filters{display:none!important}#grid{scroll-margin-top:155px}@media(max-width:760px){.areas{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important}.area,.area:nth-child(n){grid-column:span 1!important;min-height:150px!important}}';
      document.head.appendChild(style);
    }

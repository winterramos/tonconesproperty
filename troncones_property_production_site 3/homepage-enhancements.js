(function () {
  ...
  function addStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .hero{filter:saturate(1.08) contrast(1.07) brightness(1.08)!important;-webkit-filter:saturate(1.08) contrast(1.07) brightness(1.08)!important;image-rendering:auto!important;background-position:center center!important;background-size:cover!important}
  ...
  function sharpenHero(){const hero=document.querySelector('section.hero,.hero');if(!hero)return;hero.style.setProperty('filter','saturate(1.08) contrast(1.07) brightness(1.08)','important');hero.style.setProperty('-webkit-filter','saturate(1.08) contrast(1.07) brightness(1.08)','important');hero.style.setProperty('background-size','cover','important');hero.style.setProperty('background-position','center center','important')}
